...
const internalCatalog: InternalProduct[] = [
  // ─── ONLINE CERTIFICATION (UNIFIED: INDIVIDUAL + CREW) ───────────
  {
    ...
    metaDescription: `Complete your forklift operator certification online starting at $44.99/seat. ${industry.regulatory.body}-compliant training with instant certificate. Self-paced, 1-2 hours. Volume discounts available.`,
    featured: true,
    ...
    bulkPricing: [
      { minSeats: 1, pricePerSeat: 59.99, label: "1-4 seats" },
      { minSeats: 5, pricePerSeat: 54.99, label: "5-9 seats" },
      { minSeats: 10, pricePerSeat: 49.99, label: "10-24 seats" },
      { minSeats: 25, pricePerSeat: 44.99, label: "25+ seats" },
    ],
  },
