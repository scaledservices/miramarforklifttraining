...
const internalCatalog: InternalProduct[] = [
  ...
  // ─── ONLINE: AERIAL & SCISSOR LIFT CERTIFICATION ────────────────
  {
    ...
    slug: "online-aerial-scissor-lift-training",
    courseSlug: "online-aerial-scissor-lift-certification",
    category: "online",
    location: "online",
    shortDescription: `Get certified on aerial lifts and scissor lifts online. ${industry.regulatory.body}/ANSI-compliant training covering fall protection, stability, inspection, and emergency procedures.`,
    longDescription: `Our comprehensive online Aerial & Scissor Lift Operator Certification covers OSHA 29 CFR 1926.453 and ANSI/SAIA A92 standards. This self-paced course teaches safe operation of aerial lifts, scissor lifts, and boom lifts through interactive lessons covering MEWP classifications, pre-operation inspection, fall protection, stability principles, workplace hazards, electrical safety, and emergency rescue procedures. Whether you're a new operator or renewing your certification, study on any device and receive your printable certificate instantly. Training your crew? Add multiple seats and save with volume pricing.`,
    duration: "1-2 hours",
    includes: [
      "Interactive modules on MEWP types and classifications",
      "OSHA 29 CFR 1926.453 and ANSI A92 compliance",
      "Fall protection training (harness, lanyard, anchor points)",
      "Pre-operation inspection procedures",
      "Stability and load capacity training",
      "Electrical hazards and power line safety",
    ...
    ctaLabel: "Get Certified Now",
    externalPurchaseUrl: "",
    metaTitle: `Online Aerial & Scissor Lift Certification | ${industry.regulatory.body}-Compliant | ${brand.name}`,
    metaDescription: `Complete your aerial and scissor lift certification online for $59.00/seat. OSHA and ANSI A92-compliant training with instant certificate. Self-paced, 1-2 hours.`,
    featured: true,
    languages: ["English", "Spanish"],
    supportsTeam: true,
    ...
    bulkPricing: [
      ...
      { minSeats: 5, pricePerSeat: 54, label: "5+ seats" },
      { minSeats: 10, pricePerSeat: 49, label: "10+ seats" },
    ],
  },

  // ─── ONLINE: FORKLIFT TRAIN THE TRAINER ─────────────────────────
  {
    id: "forklift-ttt-online",
    title: "Forklift Train the Trainer Certification",
    slug: "online-forklift-train-the-trainer",
    courseSlug: "online-forklift-train-the-trainer",
    category: "online",
    location: "online",
    shortDescription: `Become a certified forklift trainer. Learn to train and evaluate forklift operators at your facility in compliance with OSHA 29 CFR 1910.178(l)(2)(iii).`,
    longDescription: `Our Forklift Train the Trainer Certification prepares you to become a qualified forklift operator trainer under OSHA 29 CFR 1910.178(l)(2)(iii). This comprehensive online course covers the OSHA regulatory framework, adult learning principles, training program design, all 22 required training topics, practical training methodology, operator evaluation, program administration, and safety culture. Upon completion, you will be qualified to train and evaluate forklift operators at your facility, saving on external training costs and building internal safety capacity.`,
    duration: "2-3 hours",
    includes: [
      "Complete OSHA 1910.178 regulatory framework training",
      "Adult learning principles and teaching methodology",
      "All 22 required OSHA training topics (deep dive)",
      "Practical training design and evaluation methodology",
      "Operator evaluation checklist templates",
    ...
    price: 150,
    priceLabel: "per seat",
    ctaLabel: "Get Trainer Certified",
    externalPurchaseUrl: "",
    metaTitle: `Forklift Train the Trainer Certification Online | ${brand.name}`,
    ...
    bulkPricing: [
      ...
      { minSeats: 3, pricePerSeat: 135, label: "3+ seats" },
    ],
  },

  // ─── ONLINE: FORKLIFT TTT COMBO (WITH KIT) ──────────────────────
  {
    id: "forklift-ttt-combo-online",
    title: "Forklift Train the Trainer Certification (Combo w/ Kit)",
    slug: "online-forklift-train-the-trainer-combo",
    courseSlug: "online-forklift-train-the-trainer-combo",
    category: "online",
    location: "online",
    shortDescription: `Complete Train the Trainer certification PLUS a physical training kit shipped to your facility. Everything you need to train forklift operators in-house.`,
    longDescription: `Our Forklift Train the Trainer Combo includes the full online Train the Trainer certification course PLUS a physical training kit shipped to your facility. The kit includes a printed trainer's manual, PowerPoint presentations, practical evaluation forms, pre-operation inspection checklists, operator permits, certification cards, attendance sheets, a safety poster, and a USB drive with all digital materials. Upon completing the online course, you'll be qualified to train and evaluate forklift operators under OSHA 29 CFR 1910.178(l)(2)(iii), and you'll have all the physical materials to do it effectively.`,
    duration: "2-3 hours online + kit shipped",
    includes: [
      "Full online Train the Trainer certification course",
      "Printed trainer's manual with all course content",
      "PowerPoint presentation materials",
      "Practical evaluation forms (pre-printed, carbonless)",
      "Pre-operation inspection checklists (pad of 50)",
      "Operator permits and certification cards (pad of 25)",
      "Attendance sign-in sheets",
      "Forklift safety poster for training room",
      "USB drive with digital copies of all materials",
      "Wallet card certification template",
      "Trainer certification upon completion",
    ],
    price: 480,
    priceLabel: "per seat",
    ctaLabel: "Get Combo with Kit",
    externalPurchaseUrl: "",
    metaTitle: `Forklift Train the Trainer Combo with Kit | ${brand.name}`,
  ...
  // ─── ONLINE: AERIAL LIFT TRAIN THE TRAINER ──────────────────────
  {
    id: "aerial-ttt-online",
    title: "Aerial & Scissor Lift Train the Trainer Certification",
    slug: "online-aerial-train-the-trainer",
    courseSlug: "online-aerial-train-the-trainer",
    category: "online",
    location: "online",
    shortDescription: `Become a certified aerial lift and scissor lift trainer. Learn to train and evaluate MEWP operators at your facility per OSHA and ANSI A92 standards.`,
    longDescription: `Our Aerial & Scissor Lift Train the Trainer Certification combines adult learning principles with aerial lift-specific content. This comprehensive online course covers OSHA 29 CFR 1926.453, 1910.178(l)(2)(iii), and ANSI/SAIA A92.24 training requirements. You'll learn to design and deliver aerial lift training programs, conduct practical evaluations, teach fall protection, and develop rescue plans. Upon completion, you will be qualified to train and evaluate aerial lift and scissor lift operators at your facility.`,
    duration: "2-3 hours",
    includes: [
      "OSHA 1926.453 and ANSI A92 regulatory framework",
      "ANSI A92.24 training requirements (operators, occupants, supervisors)",
      "Adult learning principles for aerial lift training",
      "All required aerial lift training topics (deep dive)",
      "Fall protection training methodology",
      "Practical training design for elevation work",
      "Operator evaluation for aerial lifts",
      "Rescue plan development",
      "Program administration and familiarization tracking",
      "Trainer certification upon completion",
      "Access on any device",
      "Unlimited retakes",
    ],
    ...
    ctaLabel: "Get Trainer Certified",
    externalPurchaseUrl: "",
    metaTitle: `Aerial Lift Train the Trainer Certification Online | ${brand.name}`,
  ...
  // ─── ONLINE: AERIAL LIFT TTT COMBO (WITH KIT) ───────────────────
  {
    id: "aerial-ttt-combo-online",
    title: "Aerial & Scissor Lift Train the Trainer Certification (Combo w/ Kit)",
    slug: "online-aerial-train-the-trainer-combo",
    courseSlug: "online-aerial-train-the-trainer-combo",
    category: "online",
    location: "online",
    shortDescription: `Complete aerial lift Train the Trainer certification PLUS a physical training kit. Everything you need to train MEWP operators in-house.`,
    longDescription: `Our Aerial & Scissor Lift Train the Trainer Combo includes the full online certification course PLUS a physical training kit shipped to your facility. The kit includes a printed trainer's manual with aerial lift content, PowerPoint presentations, practical evaluation forms for aerial lifts, pre-operation inspection checklists, operator permits, certification cards, attendance sheets, an aerial lift safety poster, fall protection inspection forms, and a USB drive with all digital materials. Upon completing the online course, you'll be qualified to train and evaluate aerial lift operators per OSHA and ANSI A92 standards.`,
    duration: "2-3 hours online + kit shipped",
    includes: [
      "Full online Aerial Lift Train the Trainer certification course",
      "Printed trainer's manual with aerial lift course content",
      "PowerPoint presentation materials for aerial/scissor lift training",
      "Practical evaluation forms for aerial lifts (pre-printed)",
      "Pre-operation inspection checklists for aerial lifts (pad of 50)",
      "Operator permits and certification cards (pad of 25)",
      "Attendance sign-in sheets",
      "Aerial lift safety poster for training room",
    ...
    ctaLabel: "Get Combo with Kit",
    externalPurchaseUrl: "",
    metaTitle: `Aerial Lift Train the Trainer Combo with Kit | ${brand.name}`,
  ...
  // 2026-09-03 (Alberto): scissor/aerial standard training REMOVED from Las
  // Vegas - the equipment is not at the LV office. Companies asking for
  // scissor training are converted to Train-the-Trainer at their own site
  // (see the trainer-category products below).
  {
    id: "reach-lv",
    image: "/images/reach-truck.jpg",
  ...
  // 2026-09-03 (Alberto): the $550 Forklift+Scissor+EPJ combo and the $650
  // complete-equipment combo are REMOVED from Las Vegas - both include
  // scissor lift, which the LV office does not have.
  ...
  // 2026-09-03 (Alberto): Fresno offers ONLY the standard $280 forklift
  // certification for now (no scissor/reach/order-picker equipment at the
  // Fresno site). Train-the-Trainer (forklift + aerial/scissor) is offered
  // for Fresno and delivered at the customer's own facility - see the
  // trainer-category products below.
  ...
  // 2026-09-03 (Alberto): Train-the-Trainer ADDED for Fresno - both forklift
  // and aerial/scissor. TTT is delivered at the customer's own facility, so
  // it works even though the Fresno office has no equipment on site.
  {
    id: "ttt-forklift-fresno",
    image: "/images/trainer-instructor.jpg",
    imageAlt: "Forklift train the trainer certification in Fresno",
    title: "Forklift Train the Trainer Certification",
    slug: "forklift-train-the-trainer-fresno",
    category: "trainer",
    location: "fresno",
    shortDescription: "Become a certified forklift trainer in Fresno. Qualify to train and certify forklift operators at your own facility.",
    longDescription: `Our Train the Trainer certification program in Fresno prepares you to become a qualified forklift training instructor. This comprehensive course covers ${industry.regulatory.body} training requirements, proper evaluation techniques, and hands-on instruction methods. Upon completion, you will be authorized to train and certify forklift operators at your workplace. Includes a binder with all materials.`,
    duration: "2-4 hours",
    includes: [
      "Full instructor-led training",
      `${industry.regulatory.body} compliance curriculum`,
    ...
    ctaLabel: "Register Now",
    externalPurchaseUrl: "",
    metaTitle: `Forklift Train the Trainer Certification Fresno | ${brand.name}`,
    metaDescription: "Become a certified forklift trainer in Fresno for $750. Comprehensive program with all materials included.",
    languages: ["English", "Spanish"],
  },
  {
    id: "ttt-scissor-fresno",
    image: "/images/trainer-instructor.jpg",
    imageAlt: "Scissor lift train the trainer certification in Fresno",
    title: "Scissor & Aerial Lift Train the Trainer Certification",
    ...
    ctaLabel: "Register Now",
    externalPurchaseUrl: "",
    metaTitle: `Scissor & Aerial Lift Train the Trainer Fresno | ${brand.name}`,
    metaDescription: `Become a certified scissor and aerial lift trainer in Fresno for $750. ${industry.regulatory.body}-compliant program with all materials.`,
    languages: ["English", "Spanish"],
  },
