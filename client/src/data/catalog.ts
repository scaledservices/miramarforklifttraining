...
const internalCatalog: InternalProduct[] = [
  ...
  {
    id: "scissor-aerial-fresno",
    image: "/images/scissor-lift.jpg",
    imageAlt: "Scissor lift certification training in Fresno",
    title: "Standard Scissor & Aerial/Boom Lift Certification",
    slug: "scissor-aerial-boom-lift-certification-fresno",
    category: "hands-on",
    location: "fresno",
    shortDescription: `Get certified on scissor lifts and aerial/boom lifts in Fresno. Hands-on instruction for safe, ${industry.regulatory.body}-compliant lift operation.`,
    longDescription: `Elevate your career with our Standard Scissor & Aerial/Boom Lift Training in Fresno, offering hands-on instruction for safe, ${industry.regulatory.body}-compliant lift operation. Get certified quickly and unlock enhanced job opportunities in industries like construction and maintenance. Ideal for first-time operators and experienced operators pursuing recertification.`,
    duration: "3-4 hrs (beginners) / 1.5-2 hrs (experienced)",
    includes: [
      "Classroom instruction and presentations",
      "Hands-on scissor lift training",
    ...
    ctaLabel: "Book Training",
    externalPurchaseUrl: "",
    metaTitle: `Scissor & Aerial Boom Lift Certification Fresno | ${brand.name}`,
    metaDescription: `Scissor and aerial/boom lift certification in Fresno for $200. Same-day ${industry.regulatory.body} certification with hands-on training.`,
    classSchedule: ["Monday 9:00 AM", "Monday 1:00 PM", "Wednesday 9:00 AM", "Wednesday 1:00 PM", "Friday 9:00 AM", "Friday 1:00 PM"],
    languages: ["English", "Spanish"],
  },
  {
    id: "reach-fresno",
    image: "/images/reach-truck.jpg",
    imageAlt: "Reach truck training and certification in Fresno",
    title: "Reach Training & Certification",
    slug: "reach-training-certification-fresno",
    category: "hands-on",
    location: "fresno",
    shortDescription: `Hands-on reach truck operator certification in Fresno. Essential skills and ${industry.regulatory.body}-compliant safety training.`,
    longDescription: `Our Reach Training & Certification in Fresno is a hands-on course that equips you with essential skills and safety knowledge for operating reach trucks efficiently and in compliance with ${industry.regulatory.body} standards. The combination of classroom instruction and hands-on training ensures you are fully prepared for safe warehouse operations.`,
    duration: "3-4 hrs (beginners) / 1.5-2 hrs (experienced)",
    includes: [
      "Classroom instruction and presentations",
      "Hands-on reach truck training",
    ...
    ctaLabel: "Book Training",
    externalPurchaseUrl: "",
    metaTitle: `Reach Truck Training & Certification Fresno | ${brand.name}`,
    metaDescription: `Reach truck operator certification in Fresno for $300. ${industry.regulatory.body}-compliant hands-on training with same-day certification.`,
    classSchedule: ["Monday 9:00 AM", "Monday 1:00 PM", "Wednesday 9:00 AM", "Wednesday 1:00 PM", "Friday 9:00 AM", "Friday 1:00 PM"],
    languages: ["English", "Spanish"],
  },
  {
    id: "order-picker-fresno",
    image: "/images/warehouse-facility.jpg",
    imageAlt: "Order picker certification in Fresno warehouse",
    title: "Order Picker Training & Certification",
    slug: "order-picker-training-certification-fresno",
    category: "hands-on",
    location: "fresno",
    shortDescription: `Order picker operator training and certification in Fresno. Hands-on program for safe, ${industry.regulatory.body}-compliant order picking operations.`,
    longDescription: `Boost your career with our Order Picker Training & Certification in Fresno, a hands-on program that equips you with the essential skills for safe, ${industry.regulatory.body}-compliant order picking operations. Get certified quickly and open doors to exciting opportunities in warehousing and logistics.`,
    duration: "3-4 hrs (beginners) / 1.5-2 hrs (experienced)",
    includes: [
      "Dynamic presentations and visual aids",
      "Real-world case studies",
    ...
    ctaLabel: "Book Training",
    externalPurchaseUrl: "",
    metaTitle: `Order Picker Training & Certification Fresno | ${brand.name}`,
    metaDescription: `Order picker operator certification in Fresno for $300. ${industry.regulatory.body}-compliant hands-on training with same-day certification.`,
    classSchedule: ["Monday 9:00 AM", "Monday 1:00 PM", "Wednesday 9:00 AM", "Wednesday 1:00 PM", "Friday 9:00 AM", "Friday 1:00 PM"],
    languages: ["English", "Spanish"],
  },
  {
    id: "reach-forklift-fresno",
    image: "/images/reach-truck.jpg",
    imageAlt: "Combined reach and forklift training in Fresno",
    title: "Hands On Reach & Forklift Training (Sit-down LPG + Reach)",
    slug: "reach-forklift-training-fresno",
    category: "hands-on",
    location: "fresno",
    shortDescription: "Dual-training combo: sit-down LPG forklift and reach truck certification in Fresno. Two certifications in one session.",
    longDescription: "Boost your career with our Hands On Reach & Forklift Training in Fresno, a comprehensive dual-training program designed to equip you with essential, hands-on skills for operating both sit-down LPG forklifts and reach trucks safely and efficiently. Get certified quickly and unlock exciting opportunities in warehousing and logistics.",
    duration: "3-4 hrs (beginners) / 1.5-2 hrs (experienced)",
    includes: [
      "Sit-down LPG forklift training",
      "Reach truck operation training",
    ...
    ctaLabel: "Book Training",
    externalPurchaseUrl: "",
    metaTitle: `Reach & Forklift Combo Training Fresno | ${brand.name}`,
    metaDescription: "Dual reach truck and forklift certification in Fresno for $490. Two certifications in one session.",
    classSchedule: ["Monday 9:00 AM", "Monday 1:00 PM", "Wednesday 9:00 AM", "Wednesday 1:00 PM", "Friday 9:00 AM", "Friday 1:00 PM"],
    languages: ["English", "Spanish"],
  },
  {
    id: "orderpicker-forklift-fresno",
    image: "/images/warehouse-facility.jpg",
    imageAlt: "Order picker and forklift training in Fresno",
    title: "Hands On Order Picker & Forklift Training (Sit-down LPG + Order Picker)",
    slug: "order-picker-forklift-training-fresno",
    category: "hands-on",
    location: "fresno",
    shortDescription: "Dual-training combo: sit-down LPG forklift and order picker certification in Fresno. Two certifications in one session.",
    longDescription: `Our specialized dual-training program in Fresno equips operators with essential skills and knowledge for managing order picking operations and forklift handling, ensuring compliance with ${industry.regulatory.body} regulations. The training includes dynamic presentations, visual aids, real-world case studies, group discussions, hands-on practical training, and comprehensive safety instruction.`,
    duration: "3-4 hrs (beginners) / 1.5-2 hrs (experienced)",
    includes: [
      "Sit-down LPG forklift training",
      "Order picker operation training",
    ...
    ctaLabel: "Book Training",
    externalPurchaseUrl: "",
    metaTitle: `Order Picker & Forklift Combo Training Fresno | ${brand.name}`,
    metaDescription: "Dual order picker and forklift certification in Fresno for $490. Two certifications in one session.",
    classSchedule: ["Monday 9:00 AM", "Monday 1:00 PM", "Wednesday 9:00 AM", "Wednesday 1:00 PM", "Friday 9:00 AM", "Friday 1:00 PM"],
    languages: ["English", "Spanish"],
  },
  {
    id: "forklift-scissor-epj-fresno",
    image: "/images/training-class.jpg",
    imageAlt: "Multi-equipment certification in Fresno",
    title: "Forklift, Scissor Lift & EPJ Certification",
    slug: "forklift-scissor-lift-epj-certification-fresno",
    category: "hands-on",
    location: "fresno",
    shortDescription: "Triple certification: sit-down LPG forklift, scissor lift, and electric pallet jack (EPJ) in Fresno.",
    longDescription: `Get certified on three equipment types in one comprehensive session in Fresno. This ${industry.regulatory.body}-compliant training covers safe operation, load handling, and workplace safety for sit-down LPG forklifts, scissor lifts, and electric pallet jacks (EPJ). The program provides essential knowledge and practical experience through classroom instruction and hands-on training.`,
    duration: "3-4 hrs (beginners) / 1.5-2 hrs (experienced)",
    includes: [
      "Sit-down LPG forklift certification",
      "Scissor lift certification",
    ...
    ctaLabel: "Book Training",
    externalPurchaseUrl: "",
    metaTitle: `Forklift, Scissor Lift & EPJ Certification Fresno | ${brand.name}`,
    metaDescription: `Triple certification in Fresno for $550: forklift, scissor lift, and EPJ. Same-day ${industry.regulatory.body} certification.`,
    equipmentCovered: ["Sit-down LPG Forklift", "Scissor Lift", "Electric Pallet Jack (EPJ)"],
    classSchedule: ["Monday 9:00 AM", "Monday 1:00 PM", "Wednesday 9:00 AM", "Wednesday 1:00 PM", "Friday 9:00 AM", "Friday 1:00 PM"],
    languages: ["English", "Spanish"],
  },
  {
    id: "all-in-one-fresno",
    image: "/images/training-class.jpg",
    imageAlt: "Complete equipment certification training in Fresno",
    title: "Forklift, Scissor Lift, Order Picker/Reach & EPJ Certification",
    slug: "complete-equipment-certification-fresno",
    category: "hands-on",
    location: "fresno",
    shortDescription: "All-in-one certification: Forklift + Scissor Lift + Order Picker/Reach + EPJ. Maximum value, complete operator qualifications in Fresno.",
    longDescription: `Our most comprehensive training package in Fresno. Get certified to operate sit-down LPG forklifts, scissor lifts (JLG 1930), order pickers/reach trucks, and electric pallet jacks (EPJ) safely and efficiently, ensuring ${industry.regulatory.body} compliance. This all-in-one program gives operators the widest range of equipment qualifications.`,
    duration: "3-4 hrs (beginners) / 1.5-2 hrs (experienced)",
    includes: [
      "Sit-down forklift (LPG) certification",
      "Scissor lift (JLG 1930) certification",
    ...
    ctaLabel: "Book Bundle",
    externalPurchaseUrl: "",
    metaTitle: `Complete Equipment Certification Bundle Fresno | ${brand.name}`,
    metaDescription: "All-in-one certification in Fresno for $650: forklift, scissor lift, order picker/reach, and EPJ.",
    equipmentCovered: ["Sit-down LPG Forklift", "Scissor Lift (JLG 1930)", "Order Picker / Reach Truck", "Electric Pallet Jack (EPJ)"],
    classSchedule: ["Monday 9:00 AM", "Monday 1:00 PM", "Wednesday 9:00 AM", "Wednesday 1:00 PM", "Friday 9:00 AM", "Friday 1:00 PM"],
    languages: ["English", "Spanish"],
  },
