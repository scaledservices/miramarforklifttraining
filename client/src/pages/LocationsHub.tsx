        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {activeLocations.map((loc) => (
            <Link key={loc.slug} href={`/locations/${loc.slug}`}>
              ...
              >
                <div className="h-48 bg-gradient-to-br from-blue-900 to-blue-700 relative overflow-hidden rounded-t-lg">
                  <div className="absolute inset-0 bg-black/20" />
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="text-xl font-bold">{loc.displayName}</h3>
                    <p className="text-sm text-blue-100">{loc.address.full}</p>
                  </div>
                </div>
          ...
          <Link href="/request-quote">
            ...
            >
              <div className="h-48 bg-gradient-to-br from-orange-700 to-orange-500 relative overflow-hidden rounded-t-lg">
                <div className="absolute inset-0 bg-black/20" />
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-xl font-bold">{t("locationsHubPage.onSiteTraining")}</h3>
                  <p className="text-sm text-orange-100">{t("locationsHubPage.onSiteSubtitle")}</p>
                </div>
              </div>
              <CardContent className="p-5">
                <p className="text-sm text-muted-foreground mb-4">
