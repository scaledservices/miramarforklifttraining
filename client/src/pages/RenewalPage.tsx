        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/book-training">
              <Button size="lg" className="bg-accent text-accent-foreground border-accent-border px-8" data-testid="button-renewal-quote">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <Card>
              <CardContent className="p-6">
                <Clock className="h-8 w-8 text-brand-orange mb-3" />
            ...
            <Card>
              <CardContent className="p-6">
                <Wrench className="h-8 w-8 text-brand-orange mb-3" />
            ...
            <Card>
              <CardContent className="p-6">
                <AlertCircle className="h-8 w-8 text-brand-orange mb-3" />
            ...
            <Card>
              <CardContent className="p-6">
                <Building2 className="h-8 w-8 text-brand-orange mb-3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-2 border-accent shadow-md">
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <ul className="space-y-2 mb-6 flex-1">
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path1F1", { defaultValue: "From $200-280 per person" })}</span></li>
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path1F2", { defaultValue: "Volume discounts for 5+" })}</span></li>
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path1F3", { defaultValue: "Train-the-Trainer for 10+" })}</span></li>
                </ul>
                <Link href="/book-training">
            ...
            <Card>
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <ul className="space-y-2 mb-6 flex-1">
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path2F1", { defaultValue: "From $200-300 per person" })}</span></li>
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path2F2", { defaultValue: "Same-day certification" })}</span></li>
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path2F3", { defaultValue: "3 locations" })}</span></li>
                </ul>
            ...
            <Card>
              <CardContent className="p-6 flex flex-col h-full">
                <div className="w-14 h-14 rounded-xl bg-primary/15 flex items-center justify-center mb-5">
                  <Monitor className="w-7 h-7 text-brand-dark" />
                </div>
                ...
                <ul className="space-y-2 mb-6 flex-1">
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path3F1", { defaultValue: "From $45-59 per seat" })}</span></li>
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path3F2", { defaultValue: "1-2 hours, self-paced" })}</span></li>
                  <li className="flex items-center gap-2 text-sm"><CheckCircle className="w-4 h-4 shrink-0 text-brand-green" /><span className="text-muted-foreground">{t("renewal.path3F3", { defaultValue: "Instant certificate" })}</span></li>
                </ul>
