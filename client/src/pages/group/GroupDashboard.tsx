...
export default function GroupDashboard() {
  ...
  // 2026-09-07 (Alberto, re-test): the dashboard member count must MATCH the
  // Members page this card links to. The Members page lists invited members
  // only (group_members rows) and does NOT show the admin, so counting admin
  // as +1 here reads one higher than the page (2 vs 1). Count invited members
  // only so both surfaces agree.
