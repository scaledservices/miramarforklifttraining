...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // Highlight uses the neutral muted tone, not the yellow brand `accent` —
      // accent-colored text (e.g. the "+ Add new member" row in GroupSeats)
      // was unreadable against a yellow focus background (Peter, 2026-09-07).
