...
export const COURSE_STEPS: StepDef[] = [
  ...
  },
  {
    ...
    config: blocks([
      ...
      { type: "hotspot_diagram", src: img("dock-scene.png"), alt: "Photorealistic side view of a loading dock with trailer interior, dock plate, concrete dock edge, and wheel chocks",
        hotspots: [
          { x: 44, y: 60, label: "Dock Plate", description: "Must be rated for your truck's weight, properly seated, and secured before you cross. Never jump the gap — enter straight and slow, forks 4–6 inches up." },
          { x: 24, y: 82, label: "Wheel Chocks", description: "Chocks against the trailer wheels stop it from creeping away from the dock. Verify them yourself — do not take anyone's word for it." },
          { x: 32, y: 46, label: "Trailer Floor", description: "Check for rot, holes, and weak boards before driving in. Confirm the trailer's landing gear or nose support if the tractor is detached." },
          { x: 56, y: 74, label: "Dock Edge", description: "An open dock is a 4-foot drop. Stay at least one tire-width from the edge and never operate near an unprotected open dock door." },
          { x: 47, y: 66, label: "Trailer Creep Gap", description: "Every forklift entry pushes the trailer slightly. Watch the gap between trailer and dock — a growing gap means the trailer is creeping and must be re-secured." },
        ] },
  ...
  // ═══ MODULE 8: Final Exam + Completion ═══
  {
    ...
    questions: [
      ...
      { question: "When is it OK to travel with a load raised more than a few inches?", type: "mcq_single", options: ["Whenever there is sufficient clearance", "Never", "Whenever it improves your visibility"], correctAnswers: "Never", explanation: "Travel with forks 4 to 6 inches from the ground at all times. A raised load moves the center of gravity up and makes tip-over much more likely." },
      ...
      { question: "If no other employees are in the area, it is OK to exceed the safe recommended speed (5 mph) as long as you are careful.", type: "mcq_single", options: ["True", "False"], correctAnswers: "False", explanation: "The 5 mph recommended maximum applies at all times, even in an empty warehouse. Speed is a leading factor in tip-overs." },
      ...
      { question: "It is a safety violation to allow anyone aboard your forklift, unless they are on a safety platform with guardrails and are wearing a safety harness.", type: "mcq_single", options: ["True", "False"], correctAnswers: "True", explanation: "No passengers, ever, unless the person is on an OSHA-approved safety platform with guardrails, toe boards, and fall protection." },
      { question: "The OSHA forklift training standard requires:", type: "mcq_single", options: ["Only formal instruction", "Practical training and evaluation", "All of the above"], correctAnswers: "All of the above", explanation: "OSHA requires formal instruction (this course), practical hands-on training, AND an evaluation of operator performance at the worksite." },
      ...
      { question: "If they ask, maintenance workers may be lifted on the forks to reach their work.", type: "mcq_single", options: ["True", "False"], correctAnswers: "False", explanation: "Never lift anyone on bare forks. Lifting people requires an OSHA-approved safety platform with guardrails and fall protection." },
      ...
      { question: "When a forklift is left unattended:", type: "mcq_single", options: ["It should be parked in a visible area with the emergency brake set and engine running", "It should be parked with the controls neutralized, brake set and engine off", "It should be parked with the controls neutralized, brake set, engine off and key removed"], correctAnswers: "It should be parked with the controls neutralized, brake set, engine off and key removed", explanation: "Unattended means full shutdown: controls neutralized, brake set, forks lowered, engine off, key removed." },
      ...
      { question: "Smoking while operating a forklift is permitted, as long as you have checked your machine for a gas leak.", type: "mcq_single", options: ["True", "False"], correctAnswers: "False", explanation: "Smoking is strictly prohibited while operating, and within 50 feet of fueling or battery charging areas." },
      ...
      { question: "When must you use the back tilt on your forklift when traveling?", type: "mcq_single", options: ["Whenever you think it is necessary", "When the forks are loaded", "At all times"], correctAnswers: "When the forks are loaded", explanation: "Tilt the mast back when traveling with a load to cradle it against the backrest and keep the center of gravity over the truck." },
